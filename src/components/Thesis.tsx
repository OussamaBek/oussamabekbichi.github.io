  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mt-10 grid gap-6 rounded-lg border border-slate-200/80 bg-gradient-to-br from-white to-cyan-50/60 p-6 shadow-soft dark:border-white/10 dark:from-white/[0.075] dark:to-cyan-400/[0.035] dark:shadow-soft-dark sm:p-8 lg:grid-cols-2"
      >
